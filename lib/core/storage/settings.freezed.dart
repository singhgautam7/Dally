...
mixin _$Settings {
 ...
 int get schemaVersion; String get paletteId; bool get hapticsEnabled; bool get soundEnabled; OnScreenControls get onScreenControls; DpadPosition get dpadPosition; int get longPressMs;/// Ludo's die sits in the corner of whoever is in turn and is tapped to
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,schemaVersion,paletteId,hapticsEnabled,soundEnabled,onScreenControls,dpadPosition,longPressMs,ludoDieFollowsTurn,reduceMotion,const DeepCollectionEquality().hash(styleChoices));

@override
String toString() {
  return 'Settings(schemaVersion: $schemaVersion, paletteId: $paletteId, hapticsEnabled: $hapticsEnabled, soundEnabled: $soundEnabled, onScreenControls: $onScreenControls, dpadPosition: $dpadPosition, longPressMs: $longPressMs, ludoDieFollowsTurn: $ludoDieFollowsTurn, reduceMotion: $reduceMotion, styleChoices: $styleChoices)';
}
...
@useResult
$Res call({
 int schemaVersion, String paletteId, bool hapticsEnabled, bool soundEnabled, OnScreenControls onScreenControls, DpadPosition dpadPosition, int longPressMs, bool ludoDieFollowsTurn, bool reduceMotion, Map<String, String> styleChoices
});
...
/// Create a copy of Settings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? schemaVersion = null,Object? paletteId = null,Object? hapticsEnabled = null,Object? soundEnabled = null,Object? onScreenControls = null,Object? dpadPosition = null,Object? longPressMs = null,Object? ludoDieFollowsTurn = null,Object? reduceMotion = null,Object? styleChoices = null,}) {
...
switch (_that) {
case _Settings() when $default != null:
return $default(_that.schemaVersion,_that.paletteId,_that.hapticsEnabled,_that.soundEnabled,_that.onScreenControls,_that.dpadPosition,_that.longPressMs,_that.ludoDieFollowsTurn,_that.reduceMotion,_that.styleChoices);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int schemaVersion,  String paletteId,  bool hapticsEnabled,  bool soundEnabled,  OnScreenControls onScreenControls,  DpadPosition dpadPosition,  int longPressMs,  bool ludoDieFollowsTurn,  bool reduceMotion,  Map<String, String> styleChoices)  $default,) {final _that = this;
switch (_that) {
case _Settings():
return $default(_that.schemaVersion,_that.paletteId,_that.hapticsEnabled,_that.soundEnabled,_that.onScreenControls,_that.dpadPosition,_that.longPressMs,_that.ludoDieFollowsTurn,_that.reduceMotion,_that.styleChoices);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int schemaVersion,  String paletteId,  bool hapticsEnabled,  bool soundEnabled,  OnScreenControls onScreenControls,  DpadPosition dpadPosition,  int longPressMs,  bool ludoDieFollowsTurn,  bool reduceMotion,  Map<String, String> styleChoices)?  $default,) {final _that = this;
switch (_that) {
case _Settings() when $default != null:
return $default(_that.schemaVersion,_that.paletteId,_that.hapticsEnabled,_that.soundEnabled,_that.onScreenControls,_that.dpadPosition,_that.longPressMs,_that.ludoDieFollowsTurn,_that.reduceMotion,_that.styleChoices);case _:
  return null;
...
class _Settings implements Settings {
  const _Settings({this.schemaVersion = 1, this.paletteId = 'ink', this.hapticsEnabled = true, this.soundEnabled = false, this.onScreenControls = OnScreenControls.dpad, this.dpadPosition = DpadPosition.centre, this.longPressMs = 400, this.ludoDieFollowsTurn = true, this.reduceMotion = false, final  Map<String, String> styleChoices = const <String, String>{}}): _styleChoices = styleChoices;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,schemaVersion,paletteId,hapticsEnabled,soundEnabled,onScreenControls,dpadPosition,longPressMs,ludoDieFollowsTurn,reduceMotion,const DeepCollectionEquality().hash(_styleChoices));
...
/// Create a copy of Settings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? schemaVersion = null,Object? paletteId = null,Object? hapticsEnabled = null,Object? soundEnabled = null,Object? onScreenControls = null,Object? dpadPosition = null,Object? longPressMs = null,Object? ludoDieFollowsTurn = null,Object? reduceMotion = null,Object? styleChoices = null,}) {
